...
const BLOCK_BUTTON: PackedScene = preload("res://pages/level_editor/menu/block_button.tscn")
const TEXT_BUTTON: PackedScene = preload("res://pages/level_editor/menu/slider_text_button.tscn")
const MUSIC_SELECTOR: PackedScene = preload("res://pages/level_editor/menu/music_selector/music_selector.tscn")
const SAVE_BUTTON: PackedScene = preload("res://pages/level_editor/menu/save_button/save_button.tscn")
const COLLAB_BUTTON: PackedScene = preload("res://pages/level_editor/menu/collab_button/collab_button.tscn")
var music_selector
